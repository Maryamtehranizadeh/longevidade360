  ...
  return (
    <div className="flex flex-col gap-y-4 max-w-5xl mx-auto p-12 my-20 text-primary shadow-lg shadow-primary rounded-3xl">
      <div>
        ...
        <p className="text-xl mb-4 italic text-center font-bold leading-loose">
          {t("about.paragraph1")}
        </p>
        ...
        <p className="text-lg mb-4 leading-loose">{t("about.paragraph3")}</p>

        <p className="text-lg mb-4 leading-loose">{t("about.paragraph4")}</p>
