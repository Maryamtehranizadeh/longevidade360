...
function TermsConditions() {
  return (
    <div className="max-w-5xl mx-auto p-12 my-20 text-primary shadow-lg shadow-primary rounded-3xl ">
      ...
      {/* <h2 className="text-2xl font-semibold mt-8 mb-4">6. Tax / Invoicing</h2>
      <p className="mb-4">
        - Medical consultations are <strong>exempt from IVA</strong> (Value
        Added Tax) under Portuguese law - Article 9.
        <br />- If you require an <strong>invoice</strong> for your records,
        please provide your{" "}
        <strong>NIF (Número de Identificação Fiscal)</strong> when necessary.
      </p> */}
